// Women's Collection Page JavaScript
...
const products = {
    1: {
        ...
        category: "dresses",
        price: 149.99,
        description: "Elegant silk evening dress perfect for special occasions. Features a flowing design with delicate details and comfortable fit.",
        features: [
            "100% Premium Silk",
            "Flowing Design",
            "Elegant Details",
    ...
    2: {
        ...
        category: "shoes",
        price: 129.99,
        description: "Luxury designer heels with comfortable padded insoles and elegant design. Perfect for both day and night wear.",
        features: [
            "Premium Leather",
            "Padded Insoles",
            "Elegant Design",
    ...
    3: {
        ...
        price: 79.99,
        oldPrice: 99.99,
        description: "Premium silk blouse with elegant design and comfortable fit. Perfect for office wear or special occasions.",
        features: [
            "100% Silk",
            "Elegant Design",
            "Comfortable Fit",
    ...
    4: {
        ...
        category: "dresses",
        price: 89.99,
        description: "Lightweight floral summer dress perfect for warm days. Features breathable fabric and comfortable design.",
        features: [
            "Lightweight Fabric",
            "Floral Pattern",
            "Breathable Material",
        ...
        sizes: ["XS", "S", "M", "L", "XL"],
        colors: ["Floral", "Blue", "Yellow", "Green"],
        rating: 5.0,
        reviews: 312,
        images: [
    ...
    5: {
        ...
        price: 199.99,
        description: "Luxury leather handbag with gold details and spacious interior. Perfect for everyday use.",
        features: [
            "Genuine Leather",
            "Gold Details",
            "Spacious Interior",
        ...
        reviews: 187,
        images: [
            "https://images.unsplash.com/photo-1590649887895-9d603f2e0bcb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
            "https://images.unsplash.com/photo-1590649887895-9d603f2e0bcb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
        ]
    },
    6: {
        ...
        category: "tops",
        price: 39.99,
        description: "Comfortable cotton t-shirt perfect for casual wear. Features soft fabric and relaxed fit.",
        features: [
            "100% Cotton",
            "Soft Fabric",
            "Relaxed Fit",
